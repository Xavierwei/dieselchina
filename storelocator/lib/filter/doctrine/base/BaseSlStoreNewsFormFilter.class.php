...
/**
 * SlStoreNews filter form base class.
 *
 * @package    collections
 * @subpackage filter
 ...
 */
abstract class BaseSlStoreNewsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('sl_store_news_filters[%s]');
