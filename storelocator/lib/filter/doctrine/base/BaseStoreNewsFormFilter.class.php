...
/**
 * StoreNews filter form base class.
 *
 * @package    collections
 * @subpackage filter
 ...
 */
abstract class BaseStoreNewsFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('store_news_filters[%s]');
