...
/**
 * SlProductLine form base class.
 *
 * @method SlProductLine getObject() Returns the current form's model object
 *
 * @package    collections
 * @subpackage form
 ...
 */
abstract class BaseSlProductLineForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('sl_product_line[%s]');
