<div id="header">
    <div class="logo"><a href="index">DIESEL</a></div>
    ...
    <div id="menu">
        <ul class="cl">
            <li>
                <a href="reboot" class="nav1"  title="#满血复活#"></a>
            </li>
            <li>
                ...
                <div class="sublevel" id="menu_collections">
                    ...
                    <ul>
                        <li><a href="http://www.dieselblackgold.com/" target="_blank" title="Diesel Black Gold">Diesel Black Gold</a></li>
                        <li><a href="http://www.diesel.com/diesel-kid" target="_blank" title="Diesel Kid">Diesel Kid</a></li>
                        <li><a href="http://www.55dsl.com" target="_blank" title="55DSL">55DSL</a></li>
                    </ul>
                </div>
            </li>
            <li>
                <a href="heritage"  class="nav3" title="关于DIESEL"></a>
            </li>
            <li>
                <a href="store-locator"  class="nav4" title="店铺位置"></a>
            </li>
            <li>
                <a target="_blank" href="http://www.diesel.com"  class="nav5" title="DIESEL.COM"></a>
            </li>
        </ul>
    </div>
</div>