...
<div id="cnt">
    <div id="homepage">
        ...
        <div class="row map_row">
            <!-- COL -->
            <div class="col c1 c2 store-locator-map" data-master="2"></div>
            <!-- COL -->
        ...
        <div class="row rs">
            <!-- COL -->
            <div class="col c1 c2 c1_2" data-color="#b6313f">
                <h2><img src="img/home/weibo_tit.gif" /></h2>
                <div class="pos-absolute pos-right pos-bottom"><img src="img/home/weibo.gif" /></div>
                <div class="links">
                    <ul>
                        <li><a class="main" target="_blank" href="http://weibo.com/dieselplanet">点击关注</a></li>
                    </ul>
                </div>
            </div>
            <!-- COL -->
...
<script src="./js/home/jquery.transit.min.js"></script>
